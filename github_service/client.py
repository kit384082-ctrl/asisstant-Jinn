...
class GitHubClient:
    ...
    def get_notifications(self) -> list[dict[str, Any]]:
        ...
        assert self.g is not None, "GitHub client is not initialized"
        user = self.g.get_user()
        assert user is not None, "Authenticated user not found"
        items = user.get_notifications(all=False, participating=False)
